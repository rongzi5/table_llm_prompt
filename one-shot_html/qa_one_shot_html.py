...
<table>
  ...
  <tbody>
    <tr>
      <td>2015</td>
      <td>Kuch Toh Hai Tere Mere Darmiyaan</td>
      <td>Sanjana Kapoor</td>
      <td>Star Plus</td>
    </tr>
    <tr>
      <td>2016</td>
      <td>Kuch Rang Pyar Ke Aise Bhi</td>
      <td>Khushi</td>
      <td>Sony TV</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>2017</td>
      <td>Iss Pyaar Ko Kya Naam Doon 3</td>
      <td>Meghna Narayan Vashishth</td>
      <td>Star Plus</td>
    </tr>
    <tr>
      <td>2017–18</td>
      <td>Tu Aashiqui</td>
      <td>Richa Dhanrajgir</td>
      <td>Colors TV</td>
    </tr>
    <tr>
      <td>2019</td>
    ...
    <tr>
      <td>2019</td>
      <td>Vikram Betaal Ki Rahasya Gatha</td>
      <td>Rukmani/Kashi</td>
      <td>&amp;TV</td>
    </tr>
    <tr>
...
def table_to_simple_html(table_data):
    html = "<table>\n"
...
#         )[0].outputs[0].text.strip()
        html = table_to_simple_html(item.get("table",""))
